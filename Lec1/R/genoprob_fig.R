...
if(bw) {
  pdf(file="../Figs/genoprob2_bw.pdf", width=9.5, height=2, pointsize=16, onefile=TRUE)
  par(fg="black",col="black",col.axis="black",col.lab="black",
      bg=bgcolor)
} else {
...
if(!bw) {
  ...
  arrows(x2, 70, x2, 80, len=0.1, lwd=2, col=color[1])
  text(x2, 68, "?", col=color[1], adj=c(0.5,1), cex=1.2)
  points(x[3:4], c(85,85), lwd=2, cex=3)
}
...
if(bw) {
  pdf(file="../Figs/genoprob3_bw.pdf", width=9.5, height=2, pointsize=16, onefile=TRUE)
  par(fg="black",col="black",col.axis="black",col.lab="black",
      bg=bgcolor)
} else {
...
if(bw) {
  pdf(file="../Figs/genoprob4_bw.pdf", width=9.5, height=2, pointsize=16, onefile=TRUE)
  par(fg="black",col="black",col.axis="black",col.lab="black",
      bg=bgcolor)
} else {
...
if(!bw) {
  ...
  arrows(x2, 70, x2, 80, len=0.1, lwd=2, col=color[1])
  text(x2, 68, "?", col=color[1], adj=c(0.5,1), cex=1.2)
  points(x[c(3,5)], c(85,85), lwd=2, cex=3)
}
...
if(bw) {
  pdf(file="../Figs/genoprob5_bw.pdf", width=9.5, height=2, pointsize=16, onefile=TRUE)
  par(fg="black",col="black",col.axis="black",col.lab="black",
      bg=bgcolor)
} else {
...
if(bw) {
  pdf(file="../Figs/genoprob6_bw.pdf", width=9.5, height=2, pointsize=16, onefile=TRUE)
  par(fg="black",col="black",col.axis="black",col.lab="black",
      bg=bgcolor)
} else {
...
if(!bw) {
  ...
  arrows(x2, 70, x2, 80, len=0.1, lwd=2, col=color[1])
  text(x2, 68, "?", col=color[1], adj=c(0.5,1), cex=1.2)
  points(x[c(2,4)], c(85,85), lwd=2, cex=3)
}
