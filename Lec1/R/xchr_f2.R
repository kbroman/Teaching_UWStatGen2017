...
text(xlab,y+6,"(A x B) x (A x B)",cex=1.3, col=color2[1])
...
segments(xc,yc,xc-xd*2,yc,lwd=2)
points(xc,yc,pch=15,cex=4,lwd=2,col=bgcolor)
points(xc,yc,pch=0,cex=4,lwd=2)
text(xc,yc,expression(F[1]),cex=1.2)

points(xc-xd*2,yc,pch=16,cex=4.5,lwd=2,col=bgcolor)
points(xc-xd*2,yc,pch=1,cex=4.5,lwd=2)
text(xc-xd*2,yc,expression(F[1]),cex=1.2)

if(bw) {
  rect(xc-cd-cw,yc+cdown,xc-cd,yc+cdown+cl,
       lend=1, ljoin=1, lwd=2)
  rect(xc+cd,yc+cdown,xc+cd+cw,yc+cdown+clx,
       lend=1, ljoin=1, angle=45, density=20, lwd=2)
  
  rect(xc-xd*2-cd,yc+cdown,xc-xd*2-cd-cw,yc+cdown+cl,
       lend=1, ljoin=1, lwd=2)
  rect(xc-xd*2+cd,yc+cdown,xc-xd*2+cd+cw,yc+cdown+cl,
       lend=1, ljoin=1, angle=45, density=20, lwd=2)
} else {
...
segments(xc-xd,yc,xc-xd,ycp,lwd=2)
...
points(xc,yc,pch=16,cex=4.5,lwd=2,col=bgcolor)
points(xc,yc,pch=1,cex=4.5,lwd=2)
text(xc,yc,expression(F[2]),cex=1.2)
points(xc+xd,yc,pch=15,cex=4,lwd=2,col=bgcolor)
points(xc+xd,yc,pch=0,cex=4,lwd=2)
text(xc+xd,yc,expression(F[2]),cex=1.2)
...
text(x+25,y+6,"(B x A) x (A x B)",cex=1.3, col=color2[1])
...
text(x+25,y+6,"(A x B) x (B x A)",cex=1.3, col=color2[1])
...
text(x+25,y+6,"(B x A) x (B x A)",cex=1.3, col=color2[1])
